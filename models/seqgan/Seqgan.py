...
class Seqgan(Gan):
    ...
    def init_real_metric(self):
        ...
        bleu2 = Bleu(gram=2,test_text='save/test_file.txt',real_text='data/testdata/test_data_all_cut300.txt')
        bleu2.set_name('Bleu2')
    ...
    def train_real(self, data_loc=None):
        ...
        for epoch in range(self.adversarial_epoch_num):
            ...
            self.reward.update_params()
            print("Train Discriminator for 15(*3) times:")
            for _ in range(15):
                self.train_discriminator()
